...
/// <param name="LeaveConversionOtherBenefits">
/// The rest of the unused leave converted to cash: "other benefits", exempt with the 13th month up
/// to the year's 90,000 and taxable past it - never part of the per-period withholding base.
/// </param>
...
public sealed record FinalPayExtras(
    ...
    decimal LeaveConversionOtherBenefits,
